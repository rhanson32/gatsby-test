        ...
        return (
            <div className="dashboard-page">
                ...
                <div className="dashboard">
                    <Card style={{ margin: "1rem", width: "90%" }} title={<div className="dashboard-card-header"><div>Category Metrics</div> <div className="dashboard-card-key"><div className="dashboard-key-item">Red</div><div className="dashboard-key-item">Blue</div><div className="dashboard-key-item">Green</div></div></div>} headStyle={{ fontSize: "1.6rem" }}>
