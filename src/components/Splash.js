        ...
        return (
                <div className="splash-overlay">
                    ...
                    <div className="splash-text">
                        ...
                        <div className="splash-subtitle-new">Automated discovery of issues. Instant notification to anyone. Live metrics across all accounts. All for a flat, affordable monthly price. Cancel anytime.</div>
