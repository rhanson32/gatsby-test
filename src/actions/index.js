...
export const getCurrentUser = () => async dispatch => {
    ...
    if(purifyUser.type && purifyUser.type === 'federated')
    {
        ...
        const userInfo = {
            ...
            Group: 'None',
            SignedUrl: customerResponse.data[0] && customerResponse.data[0].SignedUrl.S ? customerResponse.data[0].SignedUrl.S : null,
            MFA: false,
            Type: 'Federated',
    ...
    else
    {
        ...
        if(customerResponse && user)
        {
            const userInfo = {
                ...
                Key: (customerResponse.data.length > 0 && customerResponse.data[0].ApiKey.S) || "None",
                Plan: customerResponse.data[0].Plan.S,
                SignedUrl: customerResponse.data[0].SignedUrl ? customerResponse.data[0].SignedUrl.S : 'None',
                Client: customerResponse.data[0].ClientId ? customerResponse.data[0].ClientId.S : 'None',
